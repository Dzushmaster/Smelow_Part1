...
int main()
{
    ...
    HANDLE hChild = CreateThread(NULL, 0, (LPTHREAD_START_ROUTINE)OS04_02_T1, NULL, 0, &OS04_02_T1Id);
    HANDLE hChild2 = CreateThread(NULL, 0, (LPTHREAD_START_ROUTINE)OS04_02_T2, NULL, 0, &OS04_02_T2Id);
    for (int i = 0; i < 100; i++)
    {
        Sleep(1000);
